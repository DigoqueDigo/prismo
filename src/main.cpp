...
int main(int argc, char** argv) {
    ...
    Engine::OpenFlags flags = engine_j.at("openflags").get<Engine::OpenFlags>();
    Operation::MultipleBarrier barrier = operation_j.at("barrier").get<Operation::MultipleBarrier>();
    ...
    Parser::MetricVariant metric_variant = Parser::getMetricVariant(job_j);
    Parser::EngineVariant engine_variant = Parser::getEngineVariant(engine_j);
    Parser::LoggerVariant logger_variant = Parser::getLoggerVariant(logging_j);
    ...
    boost::thread producer_thread(&Worker::Producer::run, &producer, iterations);
